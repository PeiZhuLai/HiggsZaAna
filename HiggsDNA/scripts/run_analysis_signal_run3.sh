...
# For Gen Information
outdir="/eos/home-p/pelai/HZa/parquet_Sig_MC_DNA/Sig_MC"

# rm -fr /eos/home-p/pelai/HZa/parquet_DNA/Sig_MC/mA_M5_2023postBPix
# rm -fr /eos/home-p/pelai/HZa/parquet_Sig_MC_DNA/Sig_MC/mA_M5_2022preEE
# rm -fr /eos/home-p/pelai/HZa/parquet_Sig_MC_DNA/Sig_MC/analysis_manager.pkl
