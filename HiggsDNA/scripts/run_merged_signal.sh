...
sample_list="${SAMPLE_LIST:-mA_M0p1,mA_M0p2,mA_M0p3,mA_M0p4,mA_M0p5,mA_M0p6,mA_M0p7,mA_M0p8,mA_M0p9,mA_M1,}"
years="${YEARS:-2022preEE,2022postEE,2023preBPix,2023postBPix,2024}"
# sample_list="${SAMPLE_LIST:-mA_M6,mA_M7}"
# years="${YEARS:-2022preEE,2023preBPix}"
fpo="${FPO:-1}"
...
parquet_read_retry_delay="${HIGGSDNA_PARQUET_READ_RETRY_DELAY:-20}"
