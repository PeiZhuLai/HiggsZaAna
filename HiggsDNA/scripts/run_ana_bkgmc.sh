...
outdir="${OUTDIR:-/eos/home-p/pelai/HZa/parquet_DNA_tmp/Bkg_MC}"
config="${CONFIG:-metadata/za_bkgmc_run3.json}"
...
retire_jobs="${RETIRE_JOBS:-1}" # 1 merged parquet files # 0 no merged until all jobs finished
