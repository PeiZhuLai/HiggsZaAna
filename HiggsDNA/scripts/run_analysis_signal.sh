...
python scripts/run_analysis.py --config "metadata/za_signal_run3.json" --log-level "INFO" --n_cores 15 --output_dir $outdir --unretire_jobs --batch_system "local" --short #--with_skimmed # local condor 
