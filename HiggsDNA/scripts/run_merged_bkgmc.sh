...
outdir="${OUTDIR:-/eos/project/h/htozg-dy-privatemc/pelai/HZa/parquet_merged_DNA_tmp/Bkg_MC}"
config="${CONFIG:-metadata/za_merged_bkgmc_run3.json}"
log_level="${LOG_LEVEL:-INFO}" # DEBUG # INFO
n_cores="${N_CORES:-10}"
batch_system="${BATCH_SYSTEM:-condor}" # local # condor
sample_list="${SAMPLE_LIST:-DYGto2LG_10to50,DYGto2LG_50to100,DYJetsToLL,DYGto2LG_10to100,DYJetsTo2E,DYJetsTo2Mu,DYJetsTo2Tau,ggH_M125,VBF_M125,WplusH_M125,WminusH_M125,ZH_M125,ttH_M125}"
