...
cut_name = {
    'zgammas':[         'Initial Events', r'$N_{l} \geq 2$',            'e, ee trigger || $\mu\mu$, $\mu$ triggers ', r'lepton trigger pT cut',          r'$m_{ll} > 50 \text{ GeV}$',          r'$N_{\gamma} \geq 2$',             r'$m_{ll} + m_{ll\gamma\gamma} > 185 \text{ GeV}$',                   r'$95 \text{ GeV} < m_{ll\gamma\gamma} < 180 \text{ GeV}$', 'Event Filtering', 'Total Baseline Events'],
    'zgammas_ele':[     'Initial Events', r'$N_{\textrm{e}} \geq 2$',   'ee, e triggers ',                            r'ee, e trigger pT cut',           r'$m_{\textrm{ee}} > 50 \text{ GeV}$', r'$N_{\gamma} \geq 2$',    r'$m_{\textrm{ee}} + m_{\textrm{ee}\gamma\gamma} > 185 \text{ GeV}$', r'$95 \text{ GeV} < m_{\textrm{ee}\gamma\gamma} < 180 \text{ GeV}$', 'Event Filtering', 'Total Baseline Events'],
    'zgammas_mu':[      'Initial Events', r'$N_{\mu} \geq 2$',          '$\mu\mu$, $\mu$ triggers ',                  r'$\mu\mu$, $\mu$ trigger pT cut', r'$m_{\mu\mu} > 50 \text{ GeV}$',      r'$N_{\gamma} \geq 2$',         r'$m_{\mu\mu} + m_{\mu\mu\gamma\gamma} > 185 \text{ GeV}$',           r'$95 \text{ GeV} < m_{\mu\mu\gamma\gamma} < 180 \text{ GeV}$', 'Event Filtering', 'Total Baseline Events'],
    'zgammas_w':[       'Initial Events', r'$N_{l} \geq 2$',            'e, ee trigger || $\mu\mu$, $\mu$ triggers ', r'lepton trigger pT cut',          r'$m_{ll} > 50 \text{ GeV}$',          r'$N_{\gamma} \geq 2$',             r'$m_{ll} + m_{ll\gamma\gamma} > 185 \text{ GeV}$',                   r'$95 \text{ GeV} < m_{ll\gamma\gamma} < 180 \text{ GeV}$', 'Event Filtering', 'Total Baseline Events'],
    'zgammas_ele_w':[   'Initial Events', r'$N_{\textrm{e}} \geq 2$',   'ee, e triggers ',                            r'ee, e trigger pT cut',           r'$m_{\textrm{ee}} > 50 \text{ GeV}$', r'$N_{\gamma} \geq 2$',    r'$m_{\textrm{ee}} + m_{\textrm{ee}\gamma\gamma} > 185 \text{ GeV}$', r'$95 \text{ GeV} < m_{\textrm{ee}\gamma\gamma} < 180 \text{ GeV}$', 'Event Filtering', 'Total Baseline Events'],
    'zgammas_mu_w':[    'Initial Events', r'$N_{\mu} \geq 2$',          '$\mu\mu$, $\mu$ triggers ',                  r'$\mu\mu$, $\mu$ trigger pT cut', r'$m_{\mu\mu} > 50 \text{ GeV}$',      r'$N_{\gamma} \geq 2$',         r'$m_{\mu\mu} + m_{\mu\mu\gamma\gamma} > 185 \text{ GeV}$',           r'$95 \text{ GeV} < m_{\mu\mu\gamma\gamma} < 180 \text{ GeV}$', 'Event Filtering', 'Total Baseline Events'],
}
