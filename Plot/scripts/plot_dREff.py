...
outDir = "/afs/cern.ch/work/p/pelai/HZa/HiggsZaAna/Plot/plots/sigEffVdR"
...
def _plot_sumw_vs_var_dR_year(
    ...
    *,
    ...
    frame.SetTitle("")
    frame.GetXaxis().SetTitle("dR(#gamma_{1}, #gamma_{2}) Cut")
    ...
    # simple color palette for 14 lines (ROOT default-ish)
    palette = [1, 2, 4, 6, 8, 9, 28, 46, 38, 41, 30, 32, 36, 7]
    ...
    # legend
    leg = ROOT.TLegend(0.74, 0.25, 0.98, 0.90)
    leg.SetBorderSize(0)
    leg.SetFillStyle(0)
    leg.SetTextFont(42)
