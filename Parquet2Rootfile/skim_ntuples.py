...
def decorate(data):
    ...
    data['ALP_relpt'] = data.ALP_pt / data.H_mass
    data['dR_Z_ALP'] = data.apply(lambda x: compute_dR_Z_ALP(x), axis=1) 
    data['dR_g1_g2'] = data.apply(lambda x: compute_dR_g1_g2(x), axis=1) 
    data['dR_Z_g1'] = data.apply(lambda x: compute_dR_Z_g1(x), axis=1) 
